    ...
    return (
        <>
            <form name="google-sheet" className="flex flex-col lg:flex-row lg:space-y-0 lg:space-x-2 space-x-0 space-y-2 text-lg sm:text-base" style={{ fontFamily: "'Karla', sans-serif" }}>
                <input type="email" id="email" name="email" className="form-control w-full lg:w-1/2 h-[3.4rem] px-3 font-regular text-[#1E2330] placeholder-[#6667AB] border border-[#6667AB] bg-white rounded-lg focus:shadow-outline" placeholder="Please enter your email" required />
                <VButton id="submitbtn" buttonText={typeof msg == "string" ? msg : <div className="m-auto">{loaderWhite}</div>} buttonBgColor="#6667AB" buttonTextColor="white" buttonBorderColor="black" />
            </form>
